  ...
  for (N = [], a = 0; a < t.length; a++) {
    ...
    n:
      for (; y < l && (Or.lastIndex = y, h = Or.exec(g), !!h); ) {
        ...
        if (S = Ir(m) || zr(String.fromCharCode(m)), C = Ir(Y) || zr(String.fromCharCode(Y)), X = qr(m), x = qr(Y), x ? H = !1 : C && (X || S || (H = !1)), X ? v = !1 : S && (x || C || (v = !1)), Y === 34 && h[0] === '"' && m >= 48 && m <= 57 && (v = H = !1), H && v && (H = S, v = C), !H && !v) {
...
const Y4 = {
  ...
  setup(t) {
    ...
    return wf(() => {
      ...
      (Ga(!0), Pa(kf, null, Cf(Na(l), (v, T) => (Ga(), Pa("li", {
...
const Z4 = (t, i) => {
  ...
  for (const [s, g] of i)
    a[s] = g;
  return a;
}, J4 = /* @__PURE__ */ Z4(S4, [["__scopeId", "data-v-5649707e"]]);
export {
  J4 as default
};
