import { defineComponent as ff, ref as qi, computed as wf, onMounted as mf, onUnmounted as jf, openBlock as Ga, createElementBlock as Pa, normalizeStyle as vr, normalizeClass as _u, unref as Na, toDisplayString as Xr, createCommentVNode as kf, createElementVNode as Hr, Fragment as Cf, renderList as Yf } from "vue";
var qe = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {};
function Lf(t) {
  return t && t.__esModule && Object.prototype.hasOwnProperty.call(t, "default") ? t.default : t;
}
var mg = { exports: {} }, gn = {}, zu = { exports: {} };
...
var Iu = /[!-#%-\*,-\/:;\?@\[-\]_\{\}\xA1\xA7\xAB\xB6\xB7\xBB\xBF\u037E\u0387\u055A-\u055F\u0589\u058A\u05BE\u05C0\u05C3\u05C6\u05F3\u05F4\u0609\u060A\u060C\u060D\u061B\u061E\u061F\u066A-\u066D\u06D4\u0700-\u070D\u07F7-\u07F9\u0830-\u083E\u085E\u0964\u0965\u0970\u09FD\u0A76\u0AF0\u0C84\u0DF4\u0E4F\u0E5A\u0E5B\u0F04-\u0F12\u0F14\u0F3A-\u0F3D\u0F85\u0FD0-\u0FD4\u0FD9\u0FDA\u104A-\u104F\u10FB\u1360-\u1368\u1400\u166D\u166E\u169B\u169C\u16EB-\u16ED\u1735\u1736\u17D4-\u17D6\u17D8-\u17DA\u1800-\u180A\u1944\u1945\u1A1E\u1A1F\u1AA0-\u1AA6\u1AA8-\u1AAD\u1B5A-\u1B60\u1BFC-\u1BFF\u1C3B-\u1C3F\u1C7E\u1C7F\u1CC0-\u1CC7\u1CD3\u2010-\u2027\u2030-\u2043\u2045-\u2051\u2053-\u205E\u207D\u207E\u208D\u208E\u2308-\u230B\u2329\u232A\u2768-\u2775\u27C5\u27C6\u27E6-\u27EF\u2983-\u2998\u29D8-\u29DB\u29FC\u29FD\u2CF9-\u2CFC\u2CFE\u2CFF\u2D70\u2E00-\u2E2E\u2E30-\u2E4E\u3001-\u3003\u3008-\u3011\u3014-\u301F\u3030\u303D\u30A0\u30FB\uA4FE\uA4FF\uA60D-\uA60F\uA673\uA67E\uA6F2-\uA6F7\uA874-\uA877\uA8CE\uA8CF\uA8F8-\uA8FA\uA8FC\uA92E\uA92F\uA95F\uA9C1-\uA9CD\uA9DE\uA9DF\uAA5C-\uAA5F\uAADE\uAADF\uAAF0\uAAF1\uABEB\uFD3E\uFD3F\uFE10-\uFE19\uFE30-\uFE52\uFE54-\uFE61\uFE63\uFE68\uFE6A\uFE6B\uFF01-\uFF03\uFF05-\uFF0A\uFF0C-\uFF0F\uFF1A\uFF1B\uFF1F\uFF20\uFF3B-\uFF3D\uFF3F\uFF5B\uFF5D\uFF5F-\uFF65]|\uD800[\uDD00-\uDD02\uDF9F\uDFD0]|\uD801\uDD6F|\uD802[\uDC57\uDD1F\uDD3F\uDE50-\uDE58\uDE7F\uDEF0-\uDEF6\uDF39-\uDF3F\uDF99-\uDF9C]|\uD803[\uDF55-\uDF59]|\uD804[\uDC47-\uDC4D\uDCBB\uDCBC\uDCBE-\uDCC1\uDD40-\uDD43\uDD74\uDD75\uDDC5-\uDDC8\uDDCD\uDDDB\uDDDD-\uDDDF\uDE38-\uDE3D\uDEA9]|\uD805[\uDC4B-\uDC4F\uDC5B\uDC5D\uDCC6\uDDC1-\uDDD7\uDE41-\uDE43\uDE60-\uDE6C\uDF3C-\uDF3E]|\uD806[\uDC3B\uDE3F-\uDE46\uDE9A-\uDE9C\uDE9E-\uDEA2]|\uD807[\uDC41-\uDC45\uDC70\uDC71\uDEF7\uDEF8]|\uD809[\uDC70-\uDC74]|\uD81A[\uDE6E\uDE6F\uDEF5\uDF37-\uDF3B\uDF44]|\uD81B[\uDE97-\uDE9A]|\uD82F\uDC9F|\uD836[\uDE87-\uDE8B]|\uD83A[\uDD5E\uDD5F]/, Li = {}, Fr = {};
function N6(t) {
  var i, a, s = Fr[t];
  if (s)
    return s;
...
`, "	"], $6 = ["{", "}", "|", "\\", "^", "`"].concat(U6), V6 = ["'"].concat($6), Ar = ["%", "/", "?", ";", "#"].concat(V6), Mr = ["/", "?", "#"], n5 = 255, Qr = /^[+a-z0-9A-Z_-]{0,63}$/, e5 = /^([+a-z0-9A-Z_-]{0,63})(.*)$/, Er = {
  javascript: !0,
  "javascript:": !0
}, Gr = {
  http: !0,
...
za.prototype.parse = function(t, i) {
  ...
  var f = z6.exec(l);
  if (f && (f = f[0], g = f.toLowerCase(), this.protocol = f, l = l.substr(f.length)), (i || f || l.match(/^\/\/[^@\/]+@[^@\/]+/)) && (y = l.substr(0, 2) === "//", y && !(f && Er[f]) && (l = l.substr(2), this.slashes = !0)), !Er[f] && (y || f && !Gr[f])) {
    var m = -1;
    for (a = 0; a < Mr.length; a++)
      h = l.indexOf(Mr[a]), h !== -1 && (m === -1 || h < m) && (m = h);
    var Y, S;
    for (m === -1 ? S = l.lastIndexOf("@") : S = l.lastIndexOf("@", m), S !== -1 && (Y = l.slice(0, S), l = l.slice(S + 1), this.auth = Y), m = -1, a = 0; a < Ar.length; a++)
    ...
    if (!X) {
      ...
      for (a = 0, s = x.length; a < s; a++) {
        var H = x[a];
        if (!!H && !H.match(Qr)) {
          for (var v = "", T = 0, M = H.length; T < M; T++)
            H.charCodeAt(T) > 127 ? v += "x" : v += H[T];
          if (!v.match(Qr)) {
            var N = x.slice(0, a), P = x.slice(a + 1), F = H.match(e5);
            F && (N.push(F[1]), P.unshift(F[2])), P.length && (l = P.join(".") + l), this.hostname = N.join(".");
            break;
          }
        }
      }
  ...
  var tn = l.indexOf("?");
  return tn !== -1 && (this.search = l.substr(tn), l = l.slice(0, tn)), l && (this.pathname = l), Gr[g] && this.hostname && !this.pathname && (this.pathname = ""), this;
};
...
var ai = {}, xu, Pr;
function jg() {
  return Pr || (Pr = 1, xu = /[\0-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/), xu;
}
var Tu, Nr;
function kg() {
  return Nr || (Nr = 1, Tu = /[\0-\x1F\x7F-\x9F]/), Tu;
}
var vu, Rr;
function o5() {
  return Rr || (Rr = 1, vu = /[\xAD\u0600-\u0605\u061C\u06DD\u070F\u08E2\u180E\u200B-\u200F\u202A-\u202E\u2060-\u2064\u2066-\u206F\uFEFF\uFFF9-\uFFFB]|\uD804[\uDCBD\uDCCD]|\uD82F[\uDCA0-\uDCA3]|\uD834[\uDD73-\uDD7A]|\uDB40[\uDC01\uDC20-\uDC7F]/), vu;
}
var Xu, Wr;
function Cg() {
  return Wr || (Wr = 1, Xu = /[ \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000]/), Xu;
}
var Kr;
function u5() {
  return Kr || (Kr = 1, ai.Any = jg(), ai.Cc = kg(), ai.Cf = o5(), ai.P = Iu, ai.Z = Cg()), ai;
}
(function(t) {
  function i(B) {
  ...
  function P(B) {
    return v.test(B) ? B.replace(T, N) : B;
  }
  var F = /[.?*+^$[\]\\(){}|-]/g;
  function z(B) {
    return B.replace(F, "\\$&");
  ...
  t.lib = {}, t.lib.mdurl = Li, t.lib.ucmicro = u5(), t.assign = h, t.isString = a, t.has = g, t.unescapeMd = x, t.unescapeAll = H, t.isValidEntityCode = l, t.fromCodePoint = p, t.escapeHtml = P, t.arrayReplaceAt = y, t.isSpace = tn, t.isWhiteSpace = In, t.isMdAsciiPunct = ke, t.isPunctChar = cn, t.escapeRE = z, t.normalizeReference = Ce;
})(gn);
var Va = {}, t5 = function(i, a, s) {
...
}, qr = gn.unescapeAll, s5 = function(i, a, s) {
  var g, h, y = 0, l = a, p = {
    ok: !1,
    pos: 0,
    lines: 0,
  ...
  if (i.charCodeAt(a) === 60) {
    for (a++; a < s; ) {
      if (g = i.charCodeAt(a), g === 10 || g === 60)
        return p;
      if (g === 62)
        return p.pos = a + 1, p.str = qr(i.slice(l + 1, a)), p.ok = !0, p;
      if (g === 92 && a + 1 < s) {
        a += 2;
        continue;
      }
  ...
  return l === a || h !== 0 || (p.str = qr(i.slice(l, a)), p.lines = y, p.pos = a, p.ok = !0), p;
...
var k5 = function(i) {
  var a, s, g, h, y, l, p, f, m, Y, S, C, X, x, H, v, T = i.tokens, M;
  if (!!i.md.options.linkify) {
    for (s = 0, g = T.length; s < g; s++)
      if (!(T[s].type !== "inline" || !i.md.linkify.pretest(T[s].content)))
        for (h = T[s].children, X = 0, a = h.length - 1; a >= 0; a--) {
          ...
          if (l.type === "html_inline" && (m5(l.content) && X > 0 && X--, j5(l.content) && X++), !(X > 0) && l.type === "text" && i.md.linkify.test(l.content)) {
            for (m = l.content, M = i.md.linkify.match(m), p = [], C = l.level, S = 0, M.length > 0 && M[0].index === 0 && a > 0 && h[a - 1].type === "text_special" && (M = M.slice(1)), f = 0; f < M.length; f++)
              x = M[f].url, H = i.md.normalizeLink(x), i.md.validateLink(H) && (v = M[f].text, M[f].schema ? M[f].schema === "mailto:" && !/^mailto:/i.test(v) ? v = i.md.normalizeLinkText("mailto:" + v).replace(/^mailto:/, "") : v = i.md.normalizeLinkText(v) : v = i.md.normalizeLinkText("http://" + v).replace(/^http:\/\//, ""), Y = M[f].index, Y > S && (y = new i.Token("text", "", 0), y.content = m.slice(S, Y), y.level = C, p.push(y)), y = new i.Token("link_open", "a", 1), y.attrs = [["href", H]], y.level = C++, y.markup = "linkify", y.info = "auto", p.push(y), y = new i.Token("text", "", 0), y.content = v, y.level = C, p.push(y), y = new i.Token("link_close", "a", -1), y.level = --C, y.markup = "linkify", y.info = "auto", p.push(y), S = M[f].lastIndex);
            S < m.length && (y = new i.Token("text", "", 0), y.content = m.slice(S), y.level = C, p.push(y)), T[s].children = h = w5(h, a, p);
          }
        }
  }
}, Yg = /\+-|\.\.|\?\?\?\?|!!!!|,,|--/, C5 = /\((c|tm|r)\)/i, Y5 = /\((c|tm|r)\)/ig, L5 = {
  c: "\xA9",
  r: "\xAE",
  tm: "\u2122"
};
...
function D5(t) {
  var i, a, s = 0;
  for (i = t.length - 1; i >= 0; i--)
    a = t[i], a.type === "text" && !s && Yg.test(a.content) && (a.content = a.content.replace(/\+-/g, "\xB1").replace(/\.{2,}/g, "\u2026").replace(/([?!])…/g, "$1..").replace(/([?!]){4,}/g, "$1$1$1").replace(/,{2,}/g, ",").replace(/(^|[^-])---(?=[^-]|$)/mg, "$1\u2014").replace(/(^|\s)--(?=\s|$)/mg, "$1\u2013").replace(/(^|[^-\s])--(?=[^-\s]|$)/mg, "$1\u2013")), a.type === "link_open" && a.info === "auto" && s--, a.type === "link_close" && a.info === "auto" && s++;
}
var J5 = function(i) {
  var a;
  if (!!i.md.options.typographer)
    for (a = i.tokens.length - 1; a >= 0; a--)
      i.tokens[a].type === "inline" && (C5.test(i.tokens[a].content) && Z5(i.tokens[a].children), Yg.test(i.tokens[a].content) && D5(i.tokens[a].children));
}, zr = gn.isWhiteSpace, Ir = gn.isPunctChar, Or = gn.isMdAsciiPunct, _5 = /['"]/, Ur = /['"]/g, $r = "\u2019";
function Ra(t, i, a) {
  return t.slice(0, i) + a + t.slice(i + 1);
}
function x5(t, i) {
  var a, s, g, h, y, l, p, f, m, Y, S, C, X, x, H, v, T, M, N, P, F;
  for (N = [], a = 0; a < t.length; a++) {
    for (s = t[a], p = t[a].level, T = N.length - 1; T >= 0 && !(N[T].level <= p); T--)
      ;
    if (N.length = T + 1, s.type !== "text")
      continue;
    g = s.content, y = 0, l = g.length;
    n:
      for (; y < l && (Ur.lastIndex = y, h = Ur.exec(g), !!h); ) {
        if (H = v = !0, y = h.index + 1, M = h[0] === "'", m = 32, h.index - 1 >= 0)
          m = g.charCodeAt(h.index - 1);
        else
          for (T = a - 1; T >= 0 && !(t[T].type === "softbreak" || t[T].type === "hardbreak"); T--)
            if (!!t[T].content) {
              m = t[T].content.charCodeAt(t[T].content.length - 1);
              break;
            }
        if (Y = 32, y < l)
          Y = g.charCodeAt(y);
        else
          for (T = a + 1; T < t.length && !(t[T].type === "softbreak" || t[T].type === "hardbreak"); T++)
            if (!!t[T].content) {
              Y = t[T].content.charCodeAt(0);
              break;
            }
        if (S = Or(m) || Ir(String.fromCharCode(m)), C = Or(Y) || Ir(String.fromCharCode(Y)), X = zr(m), x = zr(Y), x ? H = !1 : C && (X || S || (H = !1)), X ? v = !1 : S && (x || C || (v = !1)), Y === 34 && h[0] === '"' && m >= 48 && m <= 57 && (v = H = !1), H && v && (H = S, v = C), !H && !v) {
          M && (s.content = Ra(s.content, h.index, $r));
          continue;
        }
        if (v) {
          for (T = N.length - 1; T >= 0 && (f = N[T], !(N[T].level < p)); T--)
            if (f.single === M && N[T].level === p) {
              f = N[T], M ? (P = i.md.options.quotes[2], F = i.md.options.quotes[3]) : (P = i.md.options.quotes[0], F = i.md.options.quotes[1]), s.content = Ra(s.content, h.index, F), t[f.token].content = Ra(
                t[f.token].content,
                f.pos,
                P
              ), y += F.length - 1, f.token === a && (y += P.length - 1), g = s.content, l = g.length, N.length = T;
              continue n;
            }
        }
        H ? N.push({
          ...
          single: M,
          level: p
        }) : v && M && (s.content = Ra(s.content, h.index, $r));
      }
  }
}
var T5 = function(i) {
...
var A5 = function(i, a, s, g) {
  var h, y, l, p, f, m, Y, S, C, X, x, H, v, T, M, N, P, F;
  if (a + 2 > s || (m = a + 1, i.sCount[m] < i.blkIndent) || i.sCount[m] - i.blkIndent >= 4 || (l = i.bMarks[m] + i.tShift[m], l >= i.eMarks[m]) || (P = i.src.charCodeAt(l++), P !== 124 && P !== 45 && P !== 58) || l >= i.eMarks[m] || (F = i.src.charCodeAt(l++), F !== 124 && F !== 45 && F !== 58 && !Fu(F)) || P === 45 && Fu(F))
    return !1;
  for (; l < i.eMarks[m]; ) {
  ...
  if (y = Bu(i, a).trim(), y.indexOf("|") === -1 || i.sCount[a] - i.blkIndent >= 4 || (Y = Vr(y), Y.length && Y[0] === "" && Y.shift(), Y.length && Y[Y.length - 1] === "" && Y.pop(), S = Y.length, S === 0 || S !== X.length))
    return !1;
  if (g)
    return !0;
  for (T = i.parentType, i.parentType = "table", N = i.md.block.ruler.getRules("blockquote"), C = i.push("table_open", "table", 1), C.map = H = [a, 0], C = i.push("thead_open", "thead", 1), C.map = [a, a + 1], C = i.push("tr_open", "tr", 1), C.map = [a, a + 1], p = 0; p < Y.length; p++)
  ...
  for (C = i.push("tr_close", "tr", -1), C = i.push("thead_close", "thead", -1), m = a + 2; m < s && !(i.sCount[m] < i.blkIndent); m++) {
    ...
    if (M || (y = Bu(i, m).trim(), !y) || i.sCount[m] - i.blkIndent >= 4)
      break;
    for (Y = Vr(y), Y.length && Y[0] === "" && Y.shift(), Y.length && Y[Y.length - 1] === "" && Y.pop(), m === a + 2 && (C = i.push("tbody_open", "tbody", 1), C.map = v = [a + 2, 0]), C = i.push("tr_open", "tr", 1), C.map = [m, m + 1], p = 0; p < S; p++)
  ...
  return v && (C = i.push("tbody_close", "tbody", -1), v[1] = m), C = i.push("table_close", "table", -1), H[1] = m, i.parentType = T, i.line = m, !0;
}, M5 = function(i, a, s) {
  var g, h, y;
...
`, y.map = [a, i.line], !0;
...
}, ng = gn.isSpace, E5 = function(i, a, s, g) {
  var h, y, l, p, f, m, Y, S, C, X, x, H, v, T, M, N, P, F, z, tn, In = i.lineMax, nn = i.bMarks[a] + i.tShift[a], cn = i.eMarks[a];
  if (i.sCount[a] - i.blkIndent >= 4 || i.src.charCodeAt(nn++) !== 62)
    return !1;
  if (g)
    return !0;
  for (p = C = i.sCount[a] + 1, i.src.charCodeAt(nn) === 32 ? (nn++, p++, C++, h = !1, N = !0) : i.src.charCodeAt(nn) === 9 ? (N = !0, (i.bsCount[a] + C) % 4 === 3 ? (nn++, p++, C++, h = !1) : h = !0) : N = !1, X = [i.bMarks[a]], i.bMarks[a] = nn; nn < cn && (y = i.src.charCodeAt(nn), ng(y)); ) {
    y === 9 ? C += 4 - (C + i.bsCount[a] + (h ? 1 : 0)) % 4 : C++;
    nn++;
  }
  for (x = [i.bsCount[a]], i.bsCount[a] = i.sCount[a] + 1 + (N ? 1 : 0), m = nn >= cn, T = [i.sCount[a]], i.sCount[a] = C - p, M = [i.tShift[a]], i.tShift[a] = nn - i.bMarks[a], F = i.md.block.ruler.getRules("blockquote"), v = i.parentType, i.parentType = "blockquote", S = a + 1; S < s && (tn = i.sCount[S] < i.blkIndent, nn = i.bMarks[S] + i.tShift[S], cn = i.eMarks[S], !(nn >= cn)); S++) {
    if (i.src.charCodeAt(nn++) === 62 && !tn) {
      for (p = C = i.sCount[S] + 1, i.src.charCodeAt(nn) === 32 ? (nn++, p++, C++, h = !1, N = !0) : i.src.charCodeAt(nn) === 9 ? (N = !0, (i.bsCount[S] + C) % 4 === 3 ? (nn++, p++, C++, h = !1) : h = !0) : N = !1, X.push(i.bMarks[S]), i.bMarks[S] = nn; nn < cn && (y = i.src.charCodeAt(nn), ng(y)); ) {
        y === 9 ? C += 4 - (C + i.bsCount[S] + (h ? 1 : 0)) % 4 : C++;
        nn++;
      }
      m = nn >= cn, x.push(i.bsCount[S]), i.bsCount[S] = i.sCount[S] + 1 + (N ? 1 : 0), T.push(i.sCount[S]), i.sCount[S] = C - p, M.push(i.tShift[S]), i.tShift[S] = nn - i.bMarks[S];
      continue;
    }
    if (m)
      break;
    for (P = !1, l = 0, f = F.length; l < f; l++)
      if (F[l](i, S, s, !0)) {
        P = !0;
        break;
      }
    if (P) {
      i.lineMax = S, i.blkIndent !== 0 && (X.push(i.bMarks[S]), x.push(i.bsCount[S]), M.push(i.tShift[S]), T.push(i.sCount[S]), i.sCount[S] -= i.blkIndent);
      break;
    }
    X.push(i.bMarks[S]), x.push(i.bsCount[S]), M.push(i.tShift[S]), T.push(i.sCount[S]), i.sCount[S] = -1;
  }
  for (H = i.blkIndent, i.blkIndent = 0, z = i.push("blockquote_open", "blockquote", 1), z.markup = ">", z.map = Y = [a, 0], i.md.block.tokenize(i, a, S), z = i.push("blockquote_close", "blockquote", -1), z.markup = ">", i.lineMax = In, i.parentType = v, Y[1] = i.line, l = 0; l < M.length; l++)
    i.bMarks[l + a] = X[l], i.tShift[l + a] = M[l], i.sCount[l + a] = T[l], i.bsCount[l + a] = x[l];
...
function eg(t, i) {
  var a, s, g, h;
  return s = t.bMarks[i] + t.tShift[i], g = t.eMarks[i], a = t.src.charCodeAt(s++), a !== 42 && a !== 45 && a !== 43 || s < g && (h = t.src.charCodeAt(s), !Sg(h)) ? -1 : s;
}
function ig(t, i) {
  ...
  return g < h && (a = t.src.charCodeAt(g), !Sg(a)) ? -1 : g;
}
function N5(t, i) {
  var a, s, g = t.level + 2;
...
var R5 = function(i, a, s, g) {
  var h, y, l, p, f, m, Y, S, C, X, x, H, v, T, M, N, P, F, z, tn, In, nn, cn, ke, Ce, B, yn, an, Jn = !1, On = !0;
  if (i.sCount[a] - i.blkIndent >= 4 || i.listIndent >= 0 && i.sCount[a] - i.listIndent >= 4 && i.sCount[a] < i.blkIndent)
    return !1;
  if (g && i.parentType === "paragraph" && i.sCount[a] >= i.blkIndent && (Jn = !0), (cn = ig(i, a)) >= 0) {
  ...
  if (H = i.src.charCodeAt(cn - 1), g)
    return !0;
  for (x = i.tokens.length, Y ? (an = i.push("ordered_list_open", "ol", 1), v !== 1 && (an.attrs = [["start", v]])) : an = i.push("bullet_list_open", "ul", 1), an.map = X = [a, 0], an.markup = String.fromCharCode(H), M = a, ke = !1, yn = i.md.block.ruler.getRules("list"), F = i.parentType, i.parentType = "list"; M < s; ) {
    for (nn = cn, T = i.eMarks[M], m = N = i.sCount[M] + cn - (i.bMarks[a] + i.tShift[a]); nn < T; ) {
    ...
    if (y = nn, y >= T ? f = 1 : f = N - m, f > 4 && (f = 1), p = m + f, an = i.push("list_item_open", "li", 1), an.markup = String.fromCharCode(H), an.map = S = [a, 0], Y && (an.info = i.src.slice(Ce, cn - 1)), In = i.tight, tn = i.tShift[a], z = i.sCount[a], P = i.listIndent, i.listIndent = i.blkIndent, i.blkIndent = p, i.tight = !0, i.tShift[a] = y - i.bMarks[a], i.sCount[a] = N, y >= T && i.isEmpty(a + 1) ? i.line = Math.min(i.line + 2, s) : i.md.block.tokenize(i, a, s, !0), (!i.tight || ke) && (On = !1), ke = i.line - a > 1 && i.isEmpty(i.line - 1), i.blkIndent = i.listIndent, i.listIndent = P, i.tShift[a] = tn, i.sCount[a] = z, i.tight = In, an = i.push("list_item_close", "li", -1), an.markup = String.fromCharCode(H), M = a = i.line, S[1] = M, y = i.bMarks[a], M >= s || i.sCount[M] < i.blkIndent || i.sCount[a] - i.blkIndent >= 4)
      break;
    ...
    } else if (cn = eg(i, M), cn < 0)
      break;
    if (H !== i.src.charCodeAt(cn - 1))
      break;
  }
  return Y ? an = i.push("ordered_list_close", "ol", -1) : an = i.push("bullet_list_close", "ul", -1), an.markup = String.fromCharCode(H), X[1] = M, i.line = M, i.parentType = F, On && N5(i, x), !0;
}, W5 = gn.normalizeReference, Wa = gn.isSpace, K5 = function(i, a, s, g) {
  var h, y, l, p, f, m, Y, S, C, X, x, H, v, T, M, N, P = 0, F = i.bMarks[a] + i.tShift[a], z = i.eMarks[a], tn = a + 1;
  if (i.sCount[a] - i.blkIndent >= 4 || i.src.charCodeAt(F) !== 91)
    return !1;
  for (; ++F < z; )
    if (i.src.charCodeAt(F) === 93 && i.src.charCodeAt(F - 1) !== 92) {
      if (F + 1 === z || i.src.charCodeAt(F + 1) !== 58)
        return !1;
      break;
    }
  ...
  for (v = i.getLines(a, tn, i.blkIndent, !1).trim(), z = v.length, F = 1; F < z; F++) {
    if (h = v.charCodeAt(F), h === 91)
      return !1;
    if (h === 93) {
      C = F;
      break;
    } else
      h === 10 ? P++ : h === 92 && (F++, F < z && v.charCodeAt(F) === 10 && P++);
  }
  if (C < 0 || v.charCodeAt(C + 1) !== 58)
    return !1;
  for (F = C + 2; F < z; F++)
    if (h = v.charCodeAt(F), h === 10)
      P++;
    else if (!Wa(h))
      break;
  if (x = i.md.helpers.parseLinkDestination(v, F, z), !x.ok || (f = i.md.normalizeLink(x.str), !i.md.validateLink(f)))
    return !1;
  for (F = x.pos, P += x.lines, y = F, l = P, H = F; F < z; F++)
    if (h = v.charCodeAt(F), h === 10)
      P++;
    else if (!Wa(h))
      break;
  for (x = i.md.helpers.parseLinkTitle(v, F, z), F < z && H !== F && x.ok ? (N = x.str, F = x.pos, P += x.lines) : (N = "", F = y, P = l); F < z && (h = v.charCodeAt(F), !!Wa(h)); )
    F++;
  if (F < z && v.charCodeAt(F) !== 10 && N)
    for (N = "", F = y, P = l; F < z && (h = v.charCodeAt(F), !!Wa(h)); )
      F++;
  return F < z && v.charCodeAt(F) !== 10 || (S = W5(v.slice(1, C)), !S) ? !1 : (g || (typeof i.env.references > "u" && (i.env.references = {}), typeof i.env.references[S] > "u" && (i.env.references[S] = { title: N, href: f }), i.parentType = X, i.line = a + P + 1), !0);
}, q5 = [
  "address",
  "article",
  "aside",
  ...
  "track",
  "ul"
], no = {}, z5 = "[a-zA-Z_:][a-zA-Z0-9:._-]*", I5 = "[^\"'=<>`\\x00-\\x20]+", O5 = "'[^']*'", U5 = '"[^"]*"', $5 = "(?:" + I5 + "|" + O5 + "|" + U5 + ")", V5 = "(?:\\s+" + z5 + "(?:\\s*=\\s*" + $5 + ")?)", Zg = "<[A-Za-z][A-Za-z0-9\\-]*" + V5 + "*\\s*\\/?>", Dg = "<\\/[A-Za-z][A-Za-z0-9\\-]*\\s*>", n7 = "<!---->|<!--(?:-?[^>-])(?:-?[^-])*-->", e7 = "<[?][\\s\\S]*?[?]>", i7 = "<![A-Z]+\\s+[^>]*>", a7 = "<!\\[CDATA\\[[\\s\\S]*?\\]\\]>", o7 = new RegExp("^(?:" + Zg + "|" + Dg + "|" + n7 + "|" + e7 + "|" + i7 + "|" + a7 + ")"), u7 = new RegExp("^(?:" + Zg + "|" + Dg + ")");
no.HTML_TAG_RE = o7;
...
}, ag = gn.isSpace, g7 = function(i, a, s, g) {
  var h, y, l, p, f = i.bMarks[a] + i.tShift[a], m = i.eMarks[a];
  if (i.sCount[a] - i.blkIndent >= 4 || (h = i.src.charCodeAt(f), h !== 35 || f >= m))
    return !1;
  for (y = 1, h = i.src.charCodeAt(++f); h === 35 && f < m && y <= 6; )
    y++, h = i.src.charCodeAt(++f);
  return y > 6 || f < m && !ag(h) ? !1 : (g || (m = i.skipSpacesBack(m, f), l = i.skipCharsBack(m, 35, f), l > f && ag(i.src.charCodeAt(l - 1)) && (m = l), i.line = a + 1, p = i.push("heading_open", "h" + String(y), 1), p.markup = "########".slice(0, y), p.map = [a, i.line], p = i.push("inline", "", 0), p.content = i.src.slice(f, m).trim(), p.map = [a, i.line], p.children = [], p = i.push("heading_close", "h" + String(y), -1), p.markup = "########".slice(0, y)), !0);
}, h7 = function(i, a, s) {
  var g, h, y, l, p, f, m, Y, S, C = a + 1, X, x = i.md.block.ruler.getRules("paragraph");
  if (i.sCount[a] - i.blkIndent >= 4)
    return !1;
...
var L7 = gn.normalizeReference, Au = gn.isSpace, S7 = function(i, a) {
  var s, g, h, y, l, p, f, m, Y, S = "", C = "", X = i.pos, x = i.posMax, H = i.pos, v = !0;
  if (i.src.charCodeAt(i.pos) !== 91 || (l = i.pos + 1, y = i.md.helpers.parseLinkLabel(i, i.pos, !0), y < 0))
    return !1;
  if (p = y + 1, p < x && i.src.charCodeAt(p) === 40) {
    for (v = !1, p++; p < x && (g = i.src.charCodeAt(p), !(!Au(g) && g !== 10)); p++)
      ;
    if (p >= x)
      return !1;
    if (H = p, f = i.md.helpers.parseLinkDestination(i.src, p, i.posMax), f.ok) {
      for (S = i.md.normalizeLink(f.str), i.md.validateLink(S) ? p = f.pos : S = "", H = p; p < x && (g = i.src.charCodeAt(p), !(!Au(g) && g !== 10)); p++)
        ;
      if (f = i.md.helpers.parseLinkTitle(i.src, p, i.posMax), p < x && H !== p && f.ok)
        for (C = f.str, p = f.pos; p < x && (g = i.src.charCodeAt(p), !(!Au(g) && g !== 10)); p++)
          ;
    }
    (p >= x || i.src.charCodeAt(p) !== 41) && (v = !0), p++;
  }
  if (v) {
    if (typeof i.env.references > "u")
      return !1;
    if (p < x && i.src.charCodeAt(p) === 91 ? (H = p + 1, p = i.md.helpers.parseLinkLabel(i, p), p >= 0 ? h = i.src.slice(H, p++) : p = y + 1) : p = y + 1, h || (h = i.src.slice(l, y)), m = i.env.references[L7(h)], !m)
      return i.pos = X, !1;
    S = m.href, C = m.title;
  }
  return a || (i.pos = l, i.posMax = y, Y = i.push("link_open", "a", 1), Y.attrs = s = [["href", S]], C && s.push(["title", C]), i.linkLevel++, i.md.inline.tokenize(i), i.linkLevel--, Y = i.push("link_close", "a", -1)), i.pos = p, i.posMax = x, !0;
}, Z7 = gn.normalizeReference, Mu = gn.isSpace, D7 = function(i, a) {
  var s, g, h, y, l, p, f, m, Y, S, C, X, x, H = "", v = i.pos, T = i.posMax;
  if (i.src.charCodeAt(i.pos) !== 33 || i.src.charCodeAt(i.pos + 1) !== 91 || (p = i.pos + 2, l = i.md.helpers.parseLinkLabel(i, i.pos + 1, !1), l < 0))
    return !1;
  if (f = l + 1, f < T && i.src.charCodeAt(f) === 40) {
    for (f++; f < T && (g = i.src.charCodeAt(f), !(!Mu(g) && g !== 10)); f++)
      ;
    if (f >= T)
      return !1;
    for (x = f, Y = i.md.helpers.parseLinkDestination(i.src, f, i.posMax), Y.ok && (H = i.md.normalizeLink(Y.str), i.md.validateLink(H) ? f = Y.pos : H = ""), x = f; f < T && (g = i.src.charCodeAt(f), !(!Mu(g) && g !== 10)); f++)
      ;
    if (Y = i.md.helpers.parseLinkTitle(i.src, f, i.posMax), f < T && x !== f && Y.ok)
      for (S = Y.str, f = Y.pos; f < T && (g = i.src.charCodeAt(f), !(!Mu(g) && g !== 10)); f++)
        ;
    else
      S = "";
    if (f >= T || i.src.charCodeAt(f) !== 41)
      return i.pos = v, !1;
    f++;
  } else {
    if (typeof i.env.references > "u")
      return !1;
    if (f < T && i.src.charCodeAt(f) === 91 ? (x = f + 1, f = i.md.helpers.parseLinkLabel(i, f), f >= 0 ? y = i.src.slice(x, f++) : f = l + 1) : f = l + 1, y || (y = i.src.slice(p, l)), m = i.env.references[Z7(y)], !m)
      return i.pos = v, !1;
    H = m.href, S = m.title;
  }
  return a || (h = i.src.slice(p, l), i.md.inline.parse(
    ...
    i.env,
    X = []
  ), C = i.push("image", "img", 0), C.attrs = s = [["src", H], ["alt", ""]], C.children = X, C.content = h, S && s.push(["title", S])), i.pos = f, i.posMax = T, !0;
...
}, sg = zu.exports, B7 = gn.has, A7 = gn.isValidEntityCode, rg = gn.fromCodePoint, M7 = /^&#((?:x[a-f0-9]{1,6}|[0-9]{1,7}));/i, Q7 = /^&([a-z][a-z0-9]{1,31});/i, E7 = function(i, a) {
  var s, g, h, y, l = i.pos, p = i.posMax;
  if (i.src.charCodeAt(l) !== 38 || l + 1 >= p)
    return !1;
  if (s = i.src.charCodeAt(l + 1), s === 35) {
    if (h = i.src.slice(l).match(M7), h)
      return a || (g = h[1][0].toLowerCase() === "x" ? parseInt(h[1].slice(1), 16) : parseInt(h[1], 10), y = i.push("text_special", "", 0), y.content = A7(g) ? rg(g) : rg(65533), y.markup = h[0], y.info = "entity"), i.pos += h[0].length, !0;
  } else if (h = i.src.slice(l).match(Q7), h && B7(sg, h[1]))
    return a || (y = i.push("text_special", "", 0), y.content = sg[h[1]], y.markup = h[0], y.info = "entity"), i.pos += h[0].length, !0;
  return !1;
};
function gg(t, i) {
...
var G7 = function(i) {
  var a, s = i.tokens_meta, g = i.tokens_meta.length;
  for (gg(i, i.delimiters), a = 0; a < g; a++)
    s[a] && s[a].delimiters && gg(i, s[a].delimiters);
}, P7 = function(i) {
  ...
  a !== s && (h.length = s);
}, nt = Uu, hg = gn.isWhiteSpace, lg = gn.isPunctChar, cg = gn.isMdAsciiPunct;
function Oi(t, i, a, s) {
...
Oi.prototype.scanDelims = function(t, i) {
  var a = t, s, g, h, y, l, p, f, m, Y, S = !0, C = !0, X = this.posMax, x = this.src.charCodeAt(t);
  for (s = t > 0 ? this.src.charCodeAt(t - 1) : 32; a < X && this.src.charCodeAt(a) === x; )
    a++;
  return h = a - t, g = a < X ? this.src.charCodeAt(a) : 32, f = cg(s) || lg(String.fromCharCode(s)), Y = cg(g) || lg(String.fromCharCode(g)), p = hg(s), m = hg(g), m ? S = !1 : Y && (p || f || (S = !1)), p ? C = !1 : f && (m || Y || (C = !1)), i ? (y = S, l = C) : (y = S && (!C || f), l = C && (!S || Y)), {
    can_open: y,
    can_close: l,
    length: h
  };
...
function Ui() {
  var t;
  for (this.ruler = new yg(), t = 0; t < Qu.length; t++)
    this.ruler.push(Qu[t][0], Qu[t][1]);
  for (this.ruler2 = new yg(), t = 0; t < Eu.length; t++)
...
var R7 = Ui, Gu, dg;
function W7() {
  return dg || (dg = 1, Gu = function(t) {
    var i = {};
    t = t || {}, i.src_Any = jg().source, i.src_Cc = kg().source, i.src_Z = Cg().source, i.src_P = Iu.source, i.src_ZPCc = [i.src_Z, i.src_P, i.src_Cc].join("|"), i.src_ZCc = [i.src_Z, i.src_Cc].join("|");
    var a = "[><\uFF5C]";
...
function Ia(t) {
  ...
  Object.keys(t.__schemas__).forEach(function(l) {
    ...
    if (p !== null) {
      ...
      if (t.__compiled__[l] = f, q7(p)) {
        z7(p.validate) ? f.validate = e4(p.validate) : pg(p.validate) ? f.validate = p.validate : h(l, p), pg(p.normalize) ? f.normalize = p.normalize : p.normalize ? h(l, p) : f.normalize = bg();
        return;
      }
      if (K7(p)) {
        g.push(l);
  ...
  }), t.__compiled__[""] = { validate: null, normalize: bg() };
...
function oe(t, i) {
  if (!(this instanceof oe))
    return new oe(t, i);
  i || O7(t) && (i = t, t = {}), this.__opts__ = Pu({}, _g, i), this.__index__ = -1, this.__last_index__ = -1, this.__schema__ = "", this.__text_cache__ = "", this.__schemas__ = Pu({}, U7, t), this.__compiled__ = {}, this.__tlds__ = V7, this.__tlds_replaced__ = !1, this.re = {}, Ia(this);
}
...
(function(t, i) {
  (function(a) {
    ...
    var y, l = 2147483647, p = 36, f = 1, m = 26, Y = 38, S = 700, C = 72, X = 128, x = "-", H = /^xn--/, v = /[^\x20-\x7E]/, T = /[\x2E\u3002\uFF0E\uFF61]/g, M = {
      overflow: "Overflow: input needs wider integers to process",
      "not-basic": "Illegal input >= 0x80 (not a basic code point)",
      "invalid-input": "Invalid input"
    }, N = p - f, P = Math.floor, F = String.fromCharCode, z;
    function tn(G) {
    ...
    function nn(G, R) {
      var sn = G.split("@"), bn = "";
      sn.length > 1 && (bn = sn[0] + "@", G = sn[1]), G = G.replace(T, ".");
    ...
    function ke(G) {
      return In(G, function(R) {
        var sn = "";
        return R > 65535 && (R -= 65536, sn += F(R >>> 10 & 1023 | 55296), R = 56320 | R & 1023), sn += F(R), sn;
      }).join("");
    }
    function Ce(G) {
      ...
      for (bn = mn = Xn.length, mn && Xn.push(x); bn < Nn; ) {
        ...
        for (Dn = bn + 1, Qn - R > P((l - sn) / Dn) && tn("overflow"), sn += (Qn - R) * Dn, R = Qn, Cn = 0; Cn < Nn; ++Cn)
          if (Ln = G[Cn], Ln < R && ++sn > l && tn("overflow"), Ln == R) {
            ...
            Xn.push(F(B(vn, 0))), kn = yn(sn, Dn, bn == mn), sn = 0, ++bn;
          }
        ++sn, ++R;
      }
      return Xn.join("");
...
}, zi = gn, s4 = Va, r4 = c5, g4 = B5, h4 = d7, l4 = R7, c4 = a4, oi = Li, xg = Ru.exports, y4 = {
  default: o4,
  zero: u4,
  commonmark: t4
...
var Tg = ["http:", "https:", "mailto:"];
function f4(t) {
  var i = oi.parse(t, !0);
  if (i.hostname && (!i.protocol || Tg.indexOf(i.protocol) >= 0))
    try {
      i.hostname = xg.toASCII(i.hostname);
    } catch {
    }
...
function w4(t) {
  ...
  if (i.hostname && (!i.protocol || Tg.indexOf(i.protocol) >= 0))
    try {
      i.hostname = xg.toUnicode(i.hostname);
    } catch {
    }
...
const j4 = /* @__PURE__ */ Lf(mg.exports);
let qa = [["\0", "", "", "", "", "", "", "\x07", "\b", "	", `
...
class Xg {
  ...
  codeMapReplace(i, a = [], s) {
    let g = 0, h = "";
    const y = s.fixChineseSpacing && fg(i);
    let l = !1;
    for (let p = 0; p < i.length; p++) {
      ...
      y && (!l || Y || k4(m) || (m = " " + m), l = !!m && fg(f)), h += m, g += f.length, p += f.length - 1;
    }
    return h;
  }
...
const C4 = Object.assign(Object.assign({}, zn(Ku)), { allowedChars: "a-zA-Z0-9-_.~", lowercase: !0, separator: "-", uppercase: !1, fixChineseSpacing: !0 }), Ci = new Xg(), wg = Ci.transliterate.bind(Ci);
wg.config = Ci.config.bind(Ci), wg.setData = Ci.setData.bind(Ci);
const Yi = new class extends Xg {
  ...
  slugify(t, i) {
    ...
    return g = vg(g, RegExp(`[^${a.allowedChars}]+`, "g"), a.separator, a.ignore), s && (g = g.replace(RegExp(`^${s}+|${s}$`, "g"), "")), a.lowercase && (g = g.toLowerCase()), a.uppercase && (g = g.toUpperCase()), g;
  }
...
(function(t, i) {
  (function() {
    var a, s = "4.17.21", g = 200, h = "Unsupported core-js use. Try https://npms.io/search?q=ponyfill.", y = "Expected a function", l = "Invalid `variable` option passed into `_.template`", p = "__lodash_hash_undefined__", f = 500, m = "__lodash_placeholder__", Y = 1, S = 2, C = 4, X = 1, x = 2, H = 1, v = 2, T = 4, M = 8, N = 16, P = 32, F = 64, z = 128, tn = 256, In = 512, nn = 30, cn = "...", ke = 800, Ce = 16, B = 1, yn = 2, an = 3, Jn = 1 / 0, On = 9007199254740991, to = 17976931348623157e292, G = 0 / 0, R = 4294967295, sn = R - 1, bn = R >>> 1, mn = [
      ["ary", z],
      ["bind", H],
      ["bindKey", v],
      ["curry", M],
      ...
      ["partialRight", F],
      ["rearg", tn]
    ], kn = "[object Arguments]", Cn = "[object Array]", Qn = "[object AsyncFunction]", vn = "[object Boolean]", Bn = "[object Date]", de = "[object DOMException]", Ln = "[object Error]", Xn = "[object Function]", Nn = "[object GeneratorFunction]", Dn = "[object Map]", Un = "[object Number]", Di = "[object Null]", Je = "[object Object]", it = "[object Promise]", Hg = "[object Proxy]", Ji = "[object RegExp]", pe = "[object Set]", _i = "[object String]", $i = "[object Symbol]", Fg = "[object Undefined]", xi = "[object WeakMap]", Bg = "[object WeakSet]", Ti = "[object ArrayBuffer]", ti = "[object DataView]", so = "[object Float32Array]", ro = "[object Float64Array]", go = "[object Int8Array]", ho = "[object Int16Array]", lo = "[object Int32Array]", co = "[object Uint8Array]", yo = "[object Uint8ClampedArray]", po = "[object Uint16Array]", bo = "[object Uint32Array]", Ag = /\b__p \+= '';/g, Mg = /\b(__p \+=) '' \+/g, Qg = /(__e\(.*?\)|\b__t\)) \+\n'';/g, at = /&(?:amp|lt|gt|quot|#39);/g, ot = /[&<>"']/g, Eg = RegExp(at.source), Gg = RegExp(ot.source), Pg = /<%-([\s\S]+?)%>/g, Ng = /<%([\s\S]+?)%>/g, ut = /<%=([\s\S]+?)%>/g, Rg = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, Wg = /^\w*$/, Kg = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, fo = /[\\^$.*+?()[\]{}|]/g, qg = RegExp(fo.source), wo = /^\s+/, zg = /\s/, Ig = /\{(?:\n\/\* \[wrapped with .+\] \*\/)?\n?/, Og = /\{\n\/\* \[wrapped with (.+)\] \*/, Ug = /,? & /, $g = /[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g, Vg = /[()=,{}\[\]\/\s]/, nh = /\\(\\)?/g, eh = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, tt = /\w*$/, ih = /^[-+]0x[0-9a-f]+$/i, ah = /^0b[01]+$/i, oh = /^\[object .+?Constructor\]$/, uh = /^0o[0-7]+$/i, th = /^(?:0|[1-9]\d*)$/, sh = /[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g, Vi = /($^)/, rh = /['\n\r\u2028\u2029\\]/g, na = "\\ud800-\\udfff", gh = "\\u0300-\\u036f", hh = "\\ufe20-\\ufe2f", lh = "\\u20d0-\\u20ff", st = gh + hh + lh, rt = "\\u2700-\\u27bf", gt = "a-z\\xdf-\\xf6\\xf8-\\xff", ch = "\\xac\\xb1\\xd7\\xf7", yh = "\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf", dh = "\\u2000-\\u206f", ph = " \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000", ht = "A-Z\\xc0-\\xd6\\xd8-\\xde", lt = "\\ufe0e\\ufe0f", ct = ch + yh + dh + ph, mo = "['\u2019]", bh = "[" + na + "]", yt = "[" + ct + "]", ea = "[" + st + "]", dt = "\\d+", fh = "[" + rt + "]", pt = "[" + gt + "]", bt = "[^" + na + ct + dt + rt + gt + ht + "]", jo = "\\ud83c[\\udffb-\\udfff]", wh = "(?:" + ea + "|" + jo + ")", ft = "[^" + na + "]", ko = "(?:\\ud83c[\\udde6-\\uddff]){2}", Co = "[\\ud800-\\udbff][\\udc00-\\udfff]", si = "[" + ht + "]", wt = "\\u200d", mt = "(?:" + pt + "|" + bt + ")", mh = "(?:" + si + "|" + bt + ")", jt = "(?:" + mo + "(?:d|ll|m|re|s|t|ve))?", kt = "(?:" + mo + "(?:D|LL|M|RE|S|T|VE))?", Ct = wh + "?", Yt = "[" + lt + "]?", jh = "(?:" + wt + "(?:" + [ft, ko, Co].join("|") + ")" + Yt + Ct + ")*", kh = "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])", Ch = "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])", Lt = Yt + Ct + jh, Yh = "(?:" + [fh, ko, Co].join("|") + ")" + Lt, Lh = "(?:" + [ft + ea + "?", ea, ko, Co, bh].join("|") + ")", Sh = RegExp(mo, "g"), Zh = RegExp(ea, "g"), Yo = RegExp(jo + "(?=" + jo + ")|" + Lh + Lt, "g"), Dh = RegExp([
      si + "?" + pt + "+" + jt + "(?=" + [yt, si, "$"].join("|") + ")",
      mh + "+" + kt + "(?=" + [yt, si + mt, "$"].join("|") + ")",
      si + "?" + mt + "+" + jt,
      si + "+" + kt,
      ...
      dt,
      Yh
    ].join("|"), "g"), Jh = RegExp("[" + wt + na + st + lt + "]"), _h = /[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/, xh = [
      "Array",
      "Buffer",
      "DataView",
      "Date",
    ...
    var vh = {
      ...
      "\u2028": "u2028",
      "\u2029": "u2029"
    }, Bh = parseFloat, Ah = parseInt, St = typeof qe == "object" && qe && qe.Object === Object && qe, Mh = typeof self == "object" && self && self.Object === Object && self, Hn = St || Mh || Function("return this")(), Lo = i && !i.nodeType && i, ze = Lo && !0 && t && !t.nodeType && t, Zt = ze && ze.exports === Lo, So = Zt && St.process, ue = function() {
      try {
    ...
    function Pt(j) {
      for (var Z = j.length; Z-- && zg.test(j.charAt(Z)); )
        ;
      return Z;
    }
    var ol = xo(Hh);
    ...
    var rl = function j(Z) {
      Z = Z == null ? Hn : li.defaults(Hn.Object(), Z, li.pick(Hn, xh));
      var L = Z.Array, Q = Z.Date, I = Z.Error, rn = Z.Function, _n = Z.Math, dn = Z.Object, Fo = Z.RegExp, gl = Z.String, se = Z.TypeError, ua = L.prototype, hl = rn.prototype, ci = dn.prototype, ta = Z["__core-js_shared__"], sa = hl.toString, ln = ci.hasOwnProperty, ll = 0, Nt = function() {
        var n = /[^.]+$/.exec(ta && ta.keys && ta.keys.IE_PROTO || "");
        return n ? "Symbol(src)_1." + n : "";
      }(), ra = ci.toString, cl = sa.call(dn), yl = Hn._, dl = Fo(
      ...
      }(), pl = Z.clearTimeout !== Hn.clearTimeout && Z.clearTimeout, bl = Q && Q.now !== Hn.Date.now && Q.now, fl = Z.setTimeout !== Hn.setTimeout && Z.setTimeout, da = _n.ceil, pa = _n.floor, Bo = dn.getOwnPropertySymbols, wl = ga ? ga.isBuffer : a, zt = Z.isFinite, ml = ua.join, jl = Gt(dn.keys, dn), xn = _n.max, An = _n.min, kl = Q.now, Cl = Z.parseInt, It = _n.random, Yl = ua.reverse, Ao = ni(Z, "DataView"), Hi = ni(Z, "Map"), Mo = ni(Z, "Promise"), yi = ni(Z, "Set"), Fi = ni(Z, "WeakMap"), Bi = ni(dn, "create"), ba = Fi && new Fi(), di = {}, Ll = ei(Ao), Sl = ei(Hi), Zl = ei(Mo), Dl = ei(yi), Jl = ei(Fi), fa = Ge ? Ge.prototype : a, Ai = fa ? fa.valueOf : a, Ot = fa ? fa.toString : a;
      function c(n) {
      ...
      function Tl() {
        var n = this.__wrapped__.value(), e = this.__dir__, o = O(n), u = e < 0, r = o ? n.length : 0, d = Nc(0, r, this.__views__), b = d.start, w = d.end, k = w - b, D = u ? w : b - 1, J = this.__iteratees__, _ = J.length, A = 0, E = An(k, this.__takeCount__);
        if (!o || !u && r == k && E == k)
      ...
      Oe.prototype.clear = vl, Oe.prototype.delete = Xl, Oe.prototype.get = Hl, Oe.prototype.has = Fl, Oe.prototype.set = Bl;
      function _e(n) {
        var e = -1, o = n == null ? 0 : n.length;
        for (this.clear(); ++e < o; ) {
          var u = n[e];
      ...
      _e.prototype.clear = Al, _e.prototype.delete = Ml, _e.prototype.get = Ql, _e.prototype.has = El, _e.prototype.set = Gl;
      function xe(n) {
        var e = -1, o = n == null ? 0 : n.length;
        for (this.clear(); ++e < o; ) {
          var u = n[e];
      ...
      xe.prototype.clear = Pl, xe.prototype.delete = Nl, xe.prototype.get = Rl, xe.prototype.has = Wl, xe.prototype.set = Kl;
      function Ue(n) {
        var e = -1, o = n == null ? 0 : n.length;
      ...
      Ue.prototype.add = Ue.prototype.push = ql, Ue.prototype.has = zl;
      function fe(n) {
      ...
      fe.prototype.clear = Il, fe.prototype.delete = Ol, fe.prototype.get = Ul, fe.prototype.has = $l, fe.prototype.set = Vl;
      function Ut(n, e) {
        var o = O(n), u = !o && ii(n), r = !o && !u && Ke(n), d = !o && !u && !r && mi(n), b = o || u || r || d, w = b ? vo(n.length, gl) : [], k = w.length;
        for (var D in n)
      ...
      function ge(n, e, o, u, r, d) {
        ...
        if (J) {
          ...
          if (_ == Je || _ == kn || A && !r) {
            if (b = k || A ? {} : Ps(n), !w)
              return k ? Hc(n, ac(b, n)) : Xc(n, Vt(b, n));
          } else {
            if (!pn[_])
              return r ? n : {};
            b = Kc(n, _, w);
      ...
      function En(n) {
        return n == null ? n === a ? Fg : Di : Ie && Ie in dn(n) ? Pc(n) : ey(n);
      }
      function No(n, e) {
        return n > e;
      }
      ...
      function Gi(n, e, o, u, r) {
        return n === e ? !0 : n == null || e == null || !Yn(n) && !Yn(e) ? n !== n && e !== e : yc(n, e, o, u, Gi, r);
      }
      function yc(n, e, o, u, r, d) {
        ...
        if (A && !J)
          return d || (d = new fe()), b || mi(n) ? Qs(n, e, o, u, r, d) : Ec(n, e, k, o, u, r, d);
        if (!(o & X)) {
        ...
        return A ? (d || (d = new fe()), Gc(n, e, o, u, r, d)) : !1;
      }
      function dc(n) {
        return Yn(n) && Mn(n) == Dn;
      }
      ...
      function ls(n, e) {
        return hu(n) && Ns(e) ? Rs(Se(n), e) : function(o) {
          var u = ju(o, n);
          return u === a && u === e ? ku(o, n) : Gi(e, u, X | x);
        };
      }
      ...
      function zo(n, e, o, u) {
        var r = u ? Wh : ri, d = -1, b = e.length, w = n;
      ...
      function fi(n) {
        return function(e) {
          return Do(Jr(Dr(e).replace(Sh, "")), n, "");
        };
      }
      function Ni(n) {
        return function() {
      ...
      function Za(n, e, o, u, r, d, b, w, k, D) {
        ...
        function q() {
          ...
          return en = un.length, w ? un = iy(un, w) : K && en > 1 && un.reverse(), J && k < en && (un.length = k), this && this !== Hn && this instanceof q && (Ae = $ || Ni(Ae)), Ae.apply(me, un);
        }
        return q;
      }
      function Xs(n, e) {
      ...
      function Hs(n) {
        return function(e, o, u) {
          return u && typeof u != "number" && Gn(e, o, u) && (o = u = a), e = Be(e), o === a ? (o = e, e = 0) : o = Be(o), u = u === a ? e < o ? 1 : -1 : Be(u), Cc(e, o, u, n);
        };
      }
      function _a(n) {
        return function(e, o) {
      ...
      var Mc = yi && 1 / oa(new yi([, -0]))[1] == Jn ? function(n) {
        return new yi(n);
      } : Zu;
      function Bs(n) {
        return function(e) {
          var o = Mn(e);
          return o == Dn ? Ho(e) : o == pe ? el(e) : qh(e, n(e));
        };
      }
      function ve(n, e, o, u, r, d, b, w) {
        ...
        if (!k && typeof n != "function")
          throw new se(y);
        var D = u ? u.length : 0;
        if (D || (e &= ~(P | F), u = r = a), b = b === a ? b : xn(U(b), 0), w = w === a ? w : U(w), D -= r ? r.length : 0, e & F) {
          var J = u, _ = r;
          u = r = a;
        }
        var A = k ? a : su(n), E = [
        ...
        if (A && Vc(E, A), n = E[0], e = E[1], o = E[2], u = E[3], r = E[4], w = E[9] = E[9] === a ? k ? 0 : n.length : xn(E[9] - D, 0), !w && e & (M | N) && (e &= ~(M | N)), !e || e == H)
          var K = Fc(n, e, o);
        else
          e == M || e == N ? K = Bc(n, e, w) : (e == P || e == (H | P)) && !r.length ? K = Ac(n, e, o, u) : K = Za.apply(a, E);
        var $ = A ? bs : qs;
        return zs($(K, E), n, e);
      }
      function As(n, e, o, u) {
      ...
      function Ta(n, e) {
        var o = n.__data__;
        return Ic(e) ? o[typeof e == "string" ? "string" : "hash"] : o.map;
      }
      function ru(n) {
      ...
      function qc(n, e) {
        ...
        if (!o)
          return n;
        var u = o - 1;
        return e[u] = (o > 1 ? "& " : "") + e[u], e = e.join(o > 2 ? ", " : " "), n.replace(Ig, `{
/* [wrapped with ` + e + `] */
`);
      }
      function zc(n) {
      ...
      function He(n, e) {
        var o = typeof n;
        return e = e == null ? On : e, !!e && (o == "number" || o != "symbol" && th.test(n)) && n > -1 && n % 1 == 0 && n < e;
      }
      function Gn(n, e, o) {
        if (!jn(o))
          return !1;
      ...
      function hu(n, e) {
        if (O(n))
          return !1;
        var o = typeof n;
        return o == "number" || o == "symbol" || o == "boolean" || n == null || ee(n) ? !0 : Wg.test(n) || !Rg.test(n) || e != null && n in dn(e);
      }
      function Ic(n) {
        var e = typeof n;
      ...
      var qs = Is(bs), Wi = fl || function(n, e) {
        return Hn.setTimeout(n, e);
      }, yu = Is(Sc);
      function zs(n, e, o) {
        var u = e + "";
        return yu(n, qc(u, ay(Rc(u), o)));
      }
      function Is(n) {
        var e = 0, o = 0;
        return function() {
      ...
      var Os = $c(function(n) {
        var e = [];
        return n.charCodeAt(0) === 46 && e.push(""), n.replace(Kg, function(o, u, r, d) {
          e.push(r ? d.replace(nh, "$1") : u || o);
        }), e;
      });
      function Se(n) {
      ...
      function dy(n, e, o, u) {
        ...
        return r ? (o && typeof o != "number" && Gn(n, e, o) && (o = 0, u = r), tc(n, e, o, u)) : [];
      }
      function $s(n, e, o) {
        var u = n == null ? 0 : n.length;
        if (!u)
      ...
      function Ly(n, e, o) {
        ...
        if (!u)
          return -1;
        var r = u;
        return o !== a && (r = U(o), r = r < 0 ? xn(u + r, 0) : An(r, u - 1)), e === e ? al(n, e, r) : aa(n, Ft, r, !0);
      }
      function Sy(n, e) {
      ...
      function _d(n, e, o) {
        var u = O(n) ? Gh : At, r = arguments.length < 3;
      ...
      var ep = _a(No), ip = _a(function(n, e) {
        return n >= e;
      }), ii = ts(function() {
        return arguments;
      }()) ? ts : function(n) {
        return Yn(n) && ln.call(n, "callee") && !Kt.call(n, "callee");
      }, O = L.isArray, ap = Dt ? Vn(Dt) : lc;
      function Wn(n) {
      ...
      function Ki(n) {
        ...
        return typeof o == "function" && o instanceof o && sa.call(o) == cl;
      }
      var mu = xt ? Vn(xt) : pc;
      function fp(n) {
      ...
      var kp = _a(qo), Cp = _a(function(n, e) {
        return n <= e;
      });
      function wr(n) {
        if (!n)
      ...
      function ce(n) {
        ...
        n = Mt(n);
        var o = ah.test(n);
        return o || uh.test(n) ? Ah(n.slice(2), o ? 2 : 8) : ih.test(n) ? G : +n;
      }
      function jr(n) {
        return Le(n, Kn(n));
      }
      ...
      var qp = Xe(function(n, e) {
        return n == null ? {} : jc(n, e);
      });
      function Yr(n, e) {
        if (n == null)
          return {};
      ...
      function ab(n, e, o) {
        return e = Be(e), o === a ? (o = e, e = 0) : o = Be(o), n = ce(n), gc(n, e, o);
      }
      function ob(n, e, o) {
        ...
        if (o || n % 1 || e % 1) {
          var r = It();
          return An(n + r * (e - n + Bh("1e-" + ((r + "").length - 1))), e);
        }
        return Io(n, e);
      }
      var ub = fi(function(n, e, o) {
      ...
      function Dr(n) {
        return n = hn(n), n && n.replace(sh, Ih).replace(Zh, "");
      }
      function tb(n, e, o) {
        n = hn(n), e = ne(e);
        var u = n.length;
      ...
      function sb(n) {
        return n = hn(n), n && Gg.test(n) ? n.replace(ot, Oh) : n;
      }
      function rb(n) {
        return n = hn(n), n && qg.test(n) ? n.replace(fo, "\\$&") : n;
      }
      var gb = fi(function(n, e, o) {
        return n + (o ? "-" : "") + e.toLowerCase();
      }), hb = fi(function(n, e, o) {
        return n + (o ? " " : "") + e.toLowerCase();
      }), lb = xs("toLowerCase");
      function cb(n, e, o) {
        n = hn(n), e = U(e);
      ...
      function pb(n, e, o) {
        return o || e == null ? e = 0 : e && (e = +e), Cl(hn(n).replace(wo, ""), e || 0);
      }
      function bb(n, e, o) {
      ...
      function Cb(n, e, o) {
        ...
        var r = Ea({}, e.imports, u.imports, As), d = Tn(r), b = Xo(r, d), w, k, D = 0, J = e.interpolate || Vi, _ = "__p += '", A = Fo(
          (e.escape || Vi).source + "|" + J.source + "|" + (J === ut ? eh : Vi).source + "|" + (e.evaluate || Vi).source + "|$",
          "g"
        ), E = "//# sourceURL=" + (ln.call(e, "sourceURL") ? (e.sourceURL + "").replace(/\s/g, " ") : "lodash.templateSources[" + ++Th + "]") + `
`;
        n.replace(A, function(q, en, un, ie, Pn, ae) {
          return un || (un = ie), _ += n.slice(D, ae).replace(rh, Uh), en && (w = !0, _ += `' +
__e(` + en + `) +
'`), Pn && (k = !0, _ += `';
` + Pn + `;
__p += '`), un && (_ += `' +
...
`;
          ...
          throw new I(l);
        _ = (k ? _.replace(Ag, "") : _).replace(Mg, "$1").replace(Qg, "$1;"), _ = "function(" + (K || "obj") + `) {
` + (K ? "" : `obj || (obj = {});
...
`) + _ + `return __p
      ...
      function _b(n) {
        return n = hn(n), n && Eg.test(n) ? n.replace(at, ol) : n;
      }
      var xb = fi(function(n, e, o) {
        return n + (o ? " " : "") + e.toUpperCase();
      }), Cu = xs("toUpperCase");
      function Jr(n, e, o) {
        return n = hn(n), e = o ? a : e, e === a ? Vh(n) ? sl(n) : Rh(n) : n.match(e) || [];
      }
      ...
      var Nb = au(wn), Rb = au(Xt), Wb = au(Jo);
      function xr(n) {
        return hu(n) ? _o(Se(n)) : kc(n);
      }
      function Kb(n) {
        return function(e) {
      ...
      var ef = Da(function(n, e) {
        return n + e;
      }, 0), af = ou("ceil"), of = Da(function(n, e) {
        return n / e;
      }, 1), uf = ou("floor");
      function tf(n) {
      ...
      var cf = Da(function(n, e) {
        return n * e;
      }, 1), yf = ou("round"), df = Da(function(n, e) {
        return n - e;
      }, 0);
      function pf(n) {
      ...
      return c.after = Ad, c.ary = sr, c.assign = Lp, c.assignIn = kr, c.assignInWith = Ea, c.assignWith = Sp, c.at = Zp, c.before = rr, c.bind = bu, c.bindAll = Tb, c.bindKey = gr, c.castArray = Id, c.chain = or, c.chunk = oy, c.compact = uy, c.concat = ty, c.cond = vb, c.conforms = Xb, c.constant = Yu, c.countBy = dd, c.create = Dp, c.curry = hr, c.curryRight = lr, c.debounce = cr, c.defaults = Jp, c.defaultsDeep = _p, c.defer = Md, c.delay = Qd, c.difference = sy, c.differenceBy = ry, c.differenceWith = gy, c.drop = hy, c.dropRight = ly, c.dropRightWhile = cy, c.dropWhile = yy, c.fill = dy, c.filter = bd, c.flatMap = md, c.flatMapDeep = jd, c.flatMapDepth = kd, c.flatten = nr, c.flattenDeep = py, c.flattenDepth = by, c.flip = Ed, c.flow = Fb, c.flowRight = Bb, c.fromPairs = fy, c.functions = Bp, c.functionsIn = Ap, c.groupBy = Cd, c.initial = my, c.intersection = jy, c.intersectionBy = ky, c.intersectionWith = Cy, c.invert = Qp, c.invertBy = Ep, c.invokeMap = Ld, c.iteratee = Lu, c.keyBy = Sd, c.keys = Tn, c.keysIn = Kn, c.map = Ha, c.mapKeys = Pp, c.mapValues = Np, c.matches = Ab, c.matchesProperty = Mb, c.memoize = Ba, c.merge = Rp, c.mergeWith = Cr, c.method = Qb, c.methodOf = Eb, c.mixin = Su, c.negate = Aa, c.nthArg = Pb, c.omit = Wp, c.omitBy = Kp, c.once = Gd, c.orderBy = Zd, c.over = Nb, c.overArgs = Pd, c.overEvery = Rb, c.overSome = Wb, c.partial = fu, c.partialRight = yr, c.partition = Dd, c.pick = qp, c.pickBy = Yr, c.property = xr, c.propertyOf = Kb, c.pull = Zy, c.pullAll = ir, c.pullAllBy = Dy, c.pullAllWith = Jy, c.pullAt = _y, c.range = qb, c.rangeRight = zb, c.rearg = Nd, c.reject = xd, c.remove = xy, c.rest = Rd, c.reverse = du, c.sampleSize = vd, c.set = Ip, c.setWith = Op, c.shuffle = Xd, c.slice = Ty, c.sortBy = Bd, c.sortedUniq = My, c.sortedUniqBy = Qy, c.split = mb, c.spread = Wd, c.tail = Ey, c.take = Gy, c.takeRight = Py, c.takeRightWhile = Ny, c.takeWhile = Ry, c.tap = ud, c.throttle = Kd, c.thru = Xa, c.toArray = wr, c.toPairs = Lr, c.toPairsIn = Sr, c.toPath = Vb, c.toPlainObject = jr, c.transform = Up, c.unary = qd, c.union = Wy, c.unionBy = Ky, c.unionWith = qy, c.uniq = zy, c.uniqBy = Iy, c.uniqWith = Oy, c.unset = $p, c.unzip = pu, c.unzipWith = ar, c.update = Vp, c.updateWith = nb, c.values = ji, c.valuesIn = eb, c.without = Uy, c.words = Jr, c.wrap = zd, c.xor = $y, c.xorBy = Vy, c.xorWith = nd, c.zip = ed, c.zipObject = id, c.zipObjectDeep = ad, c.zipWith = od, c.entries = Lr, c.entriesIn = Sr, c.extend = kr, c.extendWith = Ea, Su(c, c), c.add = ef, c.attempt = _r, c.camelCase = ub, c.capitalize = Zr, c.ceil = af, c.clamp = ib, c.clone = Od, c.cloneDeep = $d, c.cloneDeepWith = Vd, c.cloneWith = Ud, c.conformsTo = np, c.deburr = Dr, c.defaultTo = Hb, c.divide = of, c.endsWith = tb, c.eq = we, c.escape = sb, c.escapeRegExp = rb, c.every = pd, c.find = fd, c.findIndex = $s, c.findKey = xp, c.findLast = wd, c.findLastIndex = Vs, c.findLastKey = Tp, c.floor = uf, c.forEach = ur, c.forEachRight = tr, c.forIn = vp, c.forInRight = Xp, c.forOwn = Hp, c.forOwnRight = Fp, c.get = ju, c.gt = ep, c.gte = ip, c.has = Mp, c.hasIn = ku, c.head = er, c.identity = qn, c.includes = Yd, c.indexOf = wy, c.inRange = ab, c.invoke = Gp, c.isArguments = ii, c.isArray = O, c.isArrayBuffer = ap, c.isArrayLike = Wn, c.isArrayLikeObject = Sn, c.isBoolean = op, c.isBuffer = Ke, c.isDate = up, c.isElement = tp, c.isEmpty = sp, c.isEqual = rp, c.isEqualWith = gp, c.isError = wu, c.isFinite = hp, c.isFunction = Fe, c.isInteger = dr, c.isLength = Ma, c.isMap = pr, c.isMatch = lp, c.isMatchWith = cp, c.isNaN = yp, c.isNative = dp, c.isNil = bp, c.isNull = pp, c.isNumber = br, c.isObject = jn, c.isObjectLike = Yn, c.isPlainObject = Ki, c.isRegExp = mu, c.isSafeInteger = fp, c.isSet = fr, c.isString = Qa, c.isSymbol = ee, c.isTypedArray = mi, c.isUndefined = wp, c.isWeakMap = mp, c.isWeakSet = jp, c.join = Yy, c.kebabCase = gb, c.last = le, c.lastIndexOf = Ly, c.lowerCase = hb, c.lowerFirst = lb, c.lt = kp, c.lte = Cp, c.max = tf, c.maxBy = sf, c.mean = rf, c.meanBy = gf, c.min = hf, c.minBy = lf, c.stubArray = Du, c.stubFalse = Ju, c.stubObject = Ib, c.stubString = Ob, c.stubTrue = Ub, c.multiply = cf, c.nth = Sy, c.noConflict = Gb, c.noop = Zu, c.now = Fa, c.pad = cb, c.padEnd = yb, c.padStart = db, c.parseInt = pb, c.random = ob, c.reduce = Jd, c.reduceRight = _d, c.repeat = bb, c.replace = fb, c.result = zp, c.round = yf, c.runInContext = j, c.sample = Td, c.size = Hd, c.snakeCase = wb, c.some = Fd, c.sortedIndex = vy, c.sortedIndexBy = Xy, c.sortedIndexOf = Hy, c.sortedLastIndex = Fy, c.sortedLastIndexBy = By, c.sortedLastIndexOf = Ay, c.startCase = jb, c.startsWith = kb, c.subtract = df, c.sum = pf, c.sumBy = bf, c.template = Cb, c.times = $b, c.toFinite = Be, c.toInteger = U, c.toLength = mr, c.toLower = Yb, c.toNumber = ce, c.toSafeInteger = Yp, c.toString = hn, c.toUpper = Lb, c.trim = Sb, c.trimEnd = Zb, c.trimStart = Db, c.truncate = Jb, c.unescape = _b, c.uniqueId = nf, c.upperCase = xb, c.upperFirst = Cu, c.each = ur, c.eachRight = tr, c.first = er, Su(c, function() {
        var n = {};
        ...
        name: "wrapper",
        func: a
      }], on.prototype.clone = _l, on.prototype.reverse = xl, on.prototype.value = Tl, c.prototype.at = td, c.prototype.chain = sd, c.prototype.commit = rd, c.prototype.next = gd, c.prototype.plant = ld, c.prototype.reverse = cd, c.prototype.toJSON = c.prototype.valueOf = c.prototype.value = yd, c.prototype.first = c.prototype.head, Xi && (c.prototype[Xi] = hd), c;
    }, li = rl();
...
const Y4 = {
  key: 0,
  class: "anchor-title"
}, L4 = { class: "menu-list" }, S4 = ["onClick", "href"], Z4 = /* @__PURE__ */ ff({
  __name: "index",
  props: {
    container: {
      type: String,
  ...
  setup(t) {
    ...
    window.history.pushState = function(x, H, v) {
      p.apply(window.history, [x, H, v]);
      const T = new Event("pushstate");
      T.state = x, T.title = H, T.url = v, window.dispatchEvent(T);
    };
    const f = window.history.replaceState;
    window.history.replaceState = function(x, H, v) {
      f.apply(window.history, [x, H, v]);
      const T = new Event("replacestate");
      T.state = x, T.title = H, T.url = v, window.dispatchEvent(T);
    };
    const m = wf(() => typeof i.classes == "string" ? {
      "anchor-container": !0,
      ...
      l.value = [], i.container ? g.value = document.querySelector(i.container).innerHTML || "" : g.value = j4().render(i.content), h.value = g.value.match(a), l.value.pop(), h.value.forEach((x) => {
        let H = "", v, T = new RegExp(/<h\d(([\s\S])*?)>/, "g");
        H = x.replace(/<\/h\d>/, "").replace(T, ""), v = i.target.indexOf(x.split("")[1] + x.split("")[2]), v !== -1 && (H.indexOf("</span>") !== -1 && (H = H.replace("</span>", "").replace(/<span(([\s\S])*?)>/g, "")), H.indexOf("</a>") !== -1 && (H = H.replace("</a>", "").replace(/<a(([\s\S])*?)>/g, "")), l.value.push({ text: H, level: v + 1 }));
      });
    ...
    return mf(() => {
      i.route && (window.addEventListener("pushstate", X), window.addEventListener("popstate", X)), Y(), C();
    }), jf(() => {
      ...
      t.title && Na(l).length > 0 ? (Ga(), Pa("div", Y4, Xr(t.title), 1)) : kf("", !0),
      Hr("div", L4, [
        (Ga(!0), Pa(Cf, null, Yf(Na(l), (v, T) => (Ga(), Pa("li", {
          ...
          Hr("a", {
            class: _u(
              s.value === T ? "anchor-item anchor-item-active" : "anchor-item"
            ),
            onClick: (M) => s.value = T,
            href: "#" + Na(Ii)(v.text)
          }, Xr(v.text), 11, S4)
...
const D4 = (t, i) => {
  ...
  for (const [s, g] of i)
    a[s] = g;
  return a;
}, _4 = /* @__PURE__ */ D4(Z4, [["__scopeId", "data-v-5f78fda7"]]);
export {
  _4 as default
};
